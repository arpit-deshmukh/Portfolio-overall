...
export function About() {
  return (
    <section id="about" className="pt-28 pb-20 px-6 max-w-6xl mx-auto text-gray-900 dark:text-white scroll-mt-20">
      <motion.div 
      ...
      >
        <div className="card p-8 md:p-10 mb-14 border border-gray-200 dark:border-zinc-800/50 bg-gray-50 dark:bg-[#111113] ">
