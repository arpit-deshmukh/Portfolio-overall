          ...
          {ARTICLES.map((article, i) => (
            ...
            >
              <div className="flex-1">
                ...
                <h3 className=" text-blue-400 hover:text-blue-500 dark:text-white text-base font-semibold  mb-1.5 group-hover:text-blue-400 transition-colors leading-snug">
                  {article.title}
                </h3>
